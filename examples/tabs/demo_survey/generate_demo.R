...
# Resolve the script's own directory so output lands beside it regardless of
# how it is invoked (Rscript passes --file=...; source() sets ofile).
...
output_dir <- if (!is.na(script_path)) dirname(normalizePath(script_path)) else "examples/tabs/demo_survey"
