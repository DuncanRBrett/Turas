...
Build a production-grade R system for tracking survey data across
multiple waves (up to 25+ waves). The system must handle:
...
1.  **Configuration-driven**: Zero hard-coding, all logic in Excel
    config files

2.  **Reusable**: Same code works for any tracking study without
    modification

3.  **Module-independent**: Does not modify or depend on existing Turas
    single-wave code
...
6.  **Statistical rigor**: Proper methods for panel vs independent
    samples

**Success Criteria**

-   Analyst can set up new tracking project in \<30 minutes by filling
    Excel templates

-   System processes 25 waves in \<2 minutes (with caching)

-   Outputs professional Excel reports with time series, significance
    tests, and visualizations

-   Handles all edge cases (missing waves, new questions, panel
    attrition, etc.)
...
**Sheet: Waves**
  ...
  **Column**          **Type**   **Required**   **Description**
  ...
  Status              Text       Yes            Complete, InProgress, Planned,
                                                Excluded
...
WaveCode \| WaveName \| FieldDate \| ProjectPath \| SampleType \| Status
\| WeightVariable \| Notes

W23 \| Wave 23 \| 2023-10-26 \| ../CCS_W23 \| Panel \| Complete \|
Weight_Final \| Baseline

W24 \| Wave 24 \| 2024-10-26 \| ../CCS_W24 \| Panel \| Complete \|
Weight_Final \| Current

W25 \| Wave 25 \| 2025-01-15 \| ../CCS_W25 \| Mixed \| Complete \|
Weight_Final \| Added refresh
...
**Sheet: Sample_Design**
  ...
  **Setting**               **Value**          **Options**       **Description**
  ------------------------- ------------------ ----------------- -----------------
  sample_design             Mixed              Panel,            Overall study
                                               Independent,      design
                                               Mixed             

  respondent_id_column      RespondentID       Text              Column name for
                                                                 unique ID

  panel_identifier_logic    Appears_Multiple   Text              How to identify
                                                                 panel

  minimum_waves_for_panel   2                  Number            Min waves to
                                                                 qualify

  handle_dropouts           Include            Include, Exclude, Dropout handling
                                               Separate          

  handle_replacements       Track              Track, Ignore     Replacement
                                                                 handling
  --------------------------------------------------------------------------------
...
**Sheet: Base_Rules**
  ...
  **Setting**            **Value**        **Description**
  ...
  sig_test_minimum       20               Don\'t test if either base \<
                                          this
...
**Sheet: Statistical_Settings**
  ...
  **Setting**                **Value**   **Options**              **Description**
  ...
  sig_test_method            z_test      z_test, t_test,          Default test
                                         chi_square               

  panel_test_method          PairedT     PairedT, Wilcoxon,       Panel-specific
                                         McNemar                  tests
  ...
  show_p\_values             Y           Y/N                      Show p-values
  ...
  adjustment_for_attrition   IPW         None, IPW, Heckman       Attrition
                                                                  weighting
  ---------------------------------------------------------------------------------
...
**Sheet: Question_Mapping (PRIMARY - User fills)**
  ...
  **Column**      **Type**   **Required**   **Description**
  ...
  QuestionType    Text       Yes            Likert, Rating, SingleChoice, MultiChoice,
                                            Numeric, OpenEnd, Binary

  Category        Text       No             Grouping (Satisfaction, Demographics, etc.)

  W23, W24,       Text       No             QuestionCode in that wave (or NA)
  W25\...                                   
...
TrackingCode \| TrackingLabel \| QuestionType \| Category \| W23 \| W24
\| W25 \| Notes

TRK_NPS \| Net Promoter Score \| Rating \| Satisfaction \| Q51 \| Q51 \|
Q51 \| Core KPI

TRK_MERCH_01 \| Merchandiser greets on arrival \| Likert \| Merchandiser
\| Q07 \| Q07 \| Q07 \|

TRK_GROUP \| Store group \| SingleChoice \| Demographics \| Q03 \| Q03
\| Q03 \| Banner

TRK_NEW_01 \| New app satisfaction \| Rating \| Digital \| NA \| NA \|
Q70 \| Added W25
...
TrackingCode \| OptionCode \| OptionLabel \| W23 \| W24 \| W25 \|
FirstWave \| LastWave \| Notes

TRK_GROUP \| Liquor \| Liquor \| Y \| Y \| Y \| W23 \| current \|

TRK_GROUP \| Online \| Online \| N \| N \| Y \| W25 \| current \| NEW

TRK_GROUP \| Wholesale \| Wholesale \| Y \| Y \| N \| W23 \| W24 \|
Discontinued
...
GRP_001 \| Merchandiser Performance \| Merchandiser \|
TRK_MERCH_01,TRK_MERCH_02,TRK_MERCH_03

GRP_002 \| Satisfaction Battery \| Satisfaction \|
TRK_SAT_01,TRK_SAT_02,TRK_SAT_03,TRK_SAT_04
...
**Sheet: Analyses**
  ...
  **Column**      **Type**   **Required**   **Description**
  ...
  AnalysisType    Text       Yes            TimeSeries, WaveChange, PanelChange,
                                            AttritionAnalysis
  ...
  SampleScope     Text       No             All, PanelOnly, IndependentOnly,
                                            ConsistentPanel
...
AnalysisID \| AnalysisName \| AnalysisType \| TrackingCodes \|
BannerCode \| FilterID \| SampleScope \| WavesInclude \| Active \|
OutputFile

AN_001 \| NPS Overall \| TimeSeries \| TRK_NPS \| \| \| All \| ALL \| Y
\| NPS_Tracking

AN_002 \| NPS by Store Group \| TimeSeries \| TRK_NPS \| TRK_GROUP \| \|
All \| ALL \| Y \| NPS_ByGroup

AN_050 \| NPS Panel Only \| TimeSeries \| TRK_NPS \| \| \| PanelOnly \|
ALL \| Y \| NPS_Panel

AN_051 \| Individual NPS Change \| PanelChange \| TRK_NPS \| \| \|
PanelOnly \| ALL \| Y \| NPS_Change

AN_052 \| Attrition Analysis \| AttritionAnalysis \| - \| \| \|
PanelOnly \| ALL \| Y \| Attrition
...
FilterID \| FilterName \| TrackingCode \| Operator \| Value \| Logic \|
Notes
...
DerivedCode \| DerivedLabel \| CalculationType \| SourceCodes \| Formula
\| MinimumValid

DRV_SAT_INDEX \| Overall Satisfaction Index\| Mean \|
TRK_SAT_01,TRK_SAT_02,TRK_SAT_03,TRK_SAT_04 \| MEAN \| 3

DRV_TOP2_SAT \| Satisfaction Top 2 Box \| Percentage \| TRK_SAT_01 \|
PROP(\>=4)\| 1
...
│ ├── Sheet: Questions \# Question list with QuestionCode, QuestionText,
Variable_Type
...
-   Variable_Type: Likert, Rating, Single_Response, Multi_Mention,
    Numeric, Open_End
...
-   For panel data: Include RespondentID column (consistent across
    waves)
...
**Data files must include:**
  ...
  **Column**     **Type**       **Required**   **Description**
  ...
  PanelStatus    Text           Optional       Original, Return, Refreshment,
                                               Replacement
  ----------------------------------------------------------------------------------
...
-   Memory efficient: Handle datasets up to 10,000 respondents × 25
    waves
...
10. **Master Orchestrator** (R/main_tracking_analysis.R)
    ...
    -   For each analysis: Build time series → Calculate comparisons →
        Test significance → Apply base rules → Format output
...
3.  **Panel-Specific Tests** (R/analysis/significance_testing.R -
    enhance)
...
#\' \@param analyses Character vector. Specific AnalysisIDs to run (NULL
= all)

#\' \@param waves Character vector. Specific waves to include (NULL =
all)
...
#\' run_tracking_analysis(\"config.xlsx\", analyses = c(\"AN_001\",
\"AN_002\"))
...
#\' \@param sample_scope \"All\", \"PanelOnly\", \"IndependentOnly\",
\"ConsistentPanel\"
...
Significance: Two-sample t-test for means, two-proportion z-test for
percentages
...
\[2025-11-05 14:30:15\] INFO: Loading configuration from:
/Projects/CCS_Tracking/tracking_config.xlsx
...
\[2025-11-05 14:30:17\] WARN: Base size below threshold: W25 Superettes
(n=28)
...
\[2025-11-05 14:30:20\] INFO: Cache hit: 24 of 25 waves loaded from
cache

\[2025-11-05 14:30:21\] INFO: Wave W25 loaded from disk

\[2025-11-05 14:30:22\] INFO: Building time series for AN_001: NPS
Overall
...
\[2025-11-05 14:30:26\] INFO: Output written:
/Projects/CCS_Tracking/output/tracking/NPS_Tracking.xlsx
...
5.  Default significance level: always 0.05 or configurable per
    analysis?
...
\# tracking_config.xlsx → Waves sheet → ProjectPath column:
\"../CCS_W23\"
...
validation \<-
validate_tracking_setup(\"Projects/NewTracker/tracking_config.xlsx\")
...
results \<-
run_tracking_analysis(\"Projects/NewTracker/tracking_config.xlsx\")
...
1.  **Start with Phase 1** - Get basic independent sample tracking
    working first
