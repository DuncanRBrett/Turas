...
**Current Status:** Production-ready (93/100 quality score)
...
| **maxdiff** | MaxDiff estimation (HB & aggregate) | Production | 93/100 |
| **pricing** | Price sensitivity & optimization | Production | 93/100 |
| **report_hub** | Combine HTML reports into branded hub | Production | 88/100 |
| **segment** | Clustering & segmentation | Production | 90/100 |
| **tabs** | Cross-tabulation & significance testing | Production | 92/100 |
| **tracker** | Longitudinal tracking & trend analysis | Production | 93/100 |
