#!/usr/bin/env python3
"""
Fix example config to use correct format (LevelNames instead of Level1, Level2, etc.)
"""
...
settings_data = [
    ...
    ["generate_market_simulator", "TRUE", "Generate interactive market simulator sheet (TRUE/FALSE)"],
...
# ==============================================================================
# SHEET 2: Attributes (CORRECTED FORMAT)
# ==============================================================================

ws_attributes = wb.create_sheet("Attributes")

# CORRECT FORMAT: Use LevelNames column with comma-separated values
attributes_data = [
    ["AttributeName", "AttributeLabel", "NumLevels", "LevelNames"],
    ["Brand", "Brand", 4, "Apple, Samsung, Google, OnePlus"],
    ["Price", "Price", 4, "$299, $399, $499, $599"],
    ["Screen_Size", "Screen Size", 3, "5.5 inches, 6.1 inches, 6.7 inches"],
    ["Battery_Life", "Battery Life", 3, "12 hours, 18 hours, 24 hours"],
    ["Camera_Quality", "Camera Quality", 3, "Basic, Good, Excellent"],
]
...
ws_attributes.column_dimensions['D'].width = 50
...
instructions = [
    ...
    ["- LevelNames should be comma-separated (e.g., 'Level1, Level2, Level3')"],
...
print("\nAttributes format:")
print("  AttributeName | AttributeLabel | NumLevels | LevelNames")
print("  Brand         | Brand          | 4         | Apple, Samsung, Google, OnePlus")
print("\nLevelNames should be comma-separated list of all levels")
