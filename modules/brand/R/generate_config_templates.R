  ...
  list(
    ...
    list(
      ...
      fields = list(
        ...
        list(name = "fieldwork_dates", required = FALSE, default = "",
             description = "When this wave was in field, in your own words. Shown in the report header next to the wave and on the About tab. Leave blank and the header shows only the date the report was generated, which is not the study's date.",
             valid_values_text = "Free text (e.g. '19 to 26 May 2026')"),
...
.build_categories_examples <- function() {
  list(
    list(Category = "Dry Seasonings & Spices", CategoryCode = "DSS",
         Active = "Y", Type = "transactional", Analysis_Depth = "full",
    ...
    list(Category = "Canned Tomatoes", CategoryCode = "CT",
         Active = "Y", Type = "transactional", Analysis_Depth = "awareness_only",
         Timeframe_Long = "12 months", Timeframe_Target = "3 months",
         Focal_Weight = 0.25, AudienceLens_Use = "")
  )
}
