...
### Why it got this way (not a criticism, just context)
...
- Dirichlet norms, CEP TURF, mental-availability network effects, funnel stage derivation and buyer-heaviness segmentation are **not closed-form recomputations** you can do in JS per filter. Re-deriving them client-side would mean porting a large chunk of the R engine to JavaScript.
