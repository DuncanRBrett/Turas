...
**Target Audience:** Analysts, Project Managers, Technical Users
...
TrackingSpecs allows custom metric specification per question. Add a `TrackingSpecs` column to question_mapping.xlsx.
...
**Interpretation:**
- DEFF = 1.0: No impact (equal weights)
- DEFF = 1.1-1.3: Moderate (10-30% reduction)
- DEFF = 1.5-2.0: High (33-50% reduction)
- DEFF > 2.0: Very high (review weighting)
...
**Structure:**
- Summary sheet - Overview of all questions
- One sheet per question - Full trend tables
...
**Structure:**
- One sheet per segment (Total, then banners)
- One row per question/metric
- Columns: QuestionCode | Question | Type | Wave1 | Wave2 | ...
...
- Matrix of all wave-pair comparisons
