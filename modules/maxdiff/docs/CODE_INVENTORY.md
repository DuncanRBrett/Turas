...
| `07_hb.R` | 966 | 10 | 11.1 | `fit_hb_model()`, `prepare_stan_data()`, `fit_approximate_hb()`, `maxdiff_extract_hb_results()`, `check_cmdstanr_availability()` | cmdstanr:: (optional), parallel:: |
