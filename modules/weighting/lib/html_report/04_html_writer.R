...
write_weighting_html_report <- function(page, output_path) {
  ...
  tryCatch({
    ...
    list(
      status = "PASS",
      message = sprintf("Weighting HTML report written successfully (%.1f KB)",
