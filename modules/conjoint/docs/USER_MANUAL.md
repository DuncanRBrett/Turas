...
**Version:** 3.1.0 **Last Updated:** March 2026 **Template:** `examples/conjoint/Conjoint_Config_Template.xlsx` (6 sheets)
...
**Turas Conjoint Module v3.1.0** **The Research LampPost (Pty) Ltd**
