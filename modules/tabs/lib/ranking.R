...
#          - EXTRACTED: Crosstab row creation to ranking/ranking_crosstabs.R
#          - ADDED: tabs_source() for subdirectory loading
#          - Reduced file size: 1,929 -> 1,018 lines (911 lines extracted)
...
if (exists("tabs_source", mode = "function")) {
  ...
  .ranking_crosstabs_path <- file.path(.ranking_dir, "ranking", "ranking_crosstabs.R")
  if (file.exists(.ranking_crosstabs_path)) {
    source(.ranking_crosstabs_path)
  }
}
...
# ==============================================================================
# RANKING CROSSTAB ROWS (V10.1 - Phase 2 Refactoring)
# ==============================================================================
# V10.1: Ranking crosstab functions extracted to ranking/ranking_crosstabs.R
# Functions available after sourcing:
#   - get_banner_subset_and_weights()
#   - format_ranking_value()
