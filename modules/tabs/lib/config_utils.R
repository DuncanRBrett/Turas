# ==============================================================================
# CONFIGURATION UTILITIES - TURAS V10.0
# ==============================================================================
...
#        - All configuration loading and typed getters
# V9.9.1 - Duplicate detection added
#        - Typed config getters introduced
# ==============================================================================
...
load_config_sheet <- function(file_path, sheet_name = "Settings") {
  ...
  tryCatch({
    ...
    # Check if error is already a TRS refusal
