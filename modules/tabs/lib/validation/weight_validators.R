# ==============================================================================
# WEIGHT VALIDATORS - V10.1 (Phase 2 Refactoring)
# ==============================================================================
...
#        - All weight validation helper functions and main orchestrator
#
...
#
# FUNCTIONS EXPORTED:
# - check_weighting_enabled() - Check if weighting is enabled
# - check_weight_variable() - Get and validate weight variable name
# - check_weight_column_exists() - Check if weight column exists in data
# - check_weight_values_valid() - Check weight values are valid
# - check_weight_distribution() - Check weight distribution
# - validate_weighting_config() - Main orchestrator function
# ==============================================================================
