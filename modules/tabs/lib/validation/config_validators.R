# ==============================================================================
# CONFIG VALIDATORS - V10.1 (Phase 2 Refactoring)
# ==============================================================================
...
#        - All config validation helper functions and main orchestrator
#
# DEPENDENCIES (must be loaded before this file):
# - log_issue() from logging_utils.R
# - get_config_value() from config_utils.R
# - safe_logical(), safe_numeric() from type_utils.R
# - tabs_refuse() from 00_guard.R
# - MAX_DECIMAL_PLACES constant from validation.R
#
# USAGE:
...
#
# FUNCTIONS EXPORTED:
# - check_alpha_config() - Validate alpha (significance level)
# - check_min_base() - Validate minimum base size
# - check_decimal_places() - Validate decimal places settings
# - check_numeric_settings() - Validate numeric question settings
# - check_output_format() - Validate and normalize output format
# - validate_crosstab_config() - Main orchestrator function
# ==============================================================================
