# ==============================================================================
# SHARED VALIDATION FUNCTIONS - TURAS V10.0
# ==============================================================================
# Extracted from shared_functions.R for better maintainability
# Provides robust input validation functions used across the toolkit
#
# CONTENTS:
# - Data frame validation
# - Numeric, logical, and character parameter validation
# - File path validation with type checking
# - Column existence validation
# - Weight vector validation
#
# DESIGN PRINCIPLES:
# - Provides specific, actionable error messages
# - Uses tabs_refuse() for consistent error handling
# - Validates types, ranges, and business rules
# - Follows TRS compliance standards
# ==============================================================================
...
validate_file_path <- function(file_path, param_name = "file_path",
  ...
  if (must_exist) {
    ...
    MAX_FILE_SIZE_BYTES <- tryCatch(get("MAX_FILE_SIZE_BYTES", envir = .GlobalEnv), error = function(e) 500 * 1024 * 1024)
