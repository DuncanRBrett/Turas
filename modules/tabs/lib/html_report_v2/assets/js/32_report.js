...
(function (global) {
  ...
  report.aboutHtml = function () {
    ...
    return '<div class="card"><h3>About this report</h3>' +
      ...
      "our in-house analysis and reporting platform. Statistical analysis runs " +
      "in R, and the report is generated by Turas itself as a self-contained " +
      "HTML document — no third-party reporting engine is involved.</p>" +
      "<p>Turas is conventional statistical software, not an AI system. Every " +
      "figure in this report is computed deterministically and can be " +
      "reproduced from the source data. AI tools were used in building and " +
      "maintaining the Turas software, as they are in most modern software " +
      "development; no AI model takes part in any calculation.</p>" +
