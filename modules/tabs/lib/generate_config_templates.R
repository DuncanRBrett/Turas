      ...
      fields = list(
        ...
        list(name = "html_report_v2_interactivity", default = "records", required = FALSE,
             description = paste0("What powers the v2 report's LIVE views. 'records' embeds the ",
               "anonymised per-respondent island: every feature works, and a recipient who opens the ",
               "file's source can rebuild a respondent-by-question dataset from it. 'cube' embeds ",
