    ...
    list(
      ...
      fields = list(
        ...
        list(name = "dashboard_metrics", default = "NET POSITIVE", required = TRUE,
             description = "Metric types to display in dashboard gauges. Comma-separated for multiple: NET POSITIVE, MEAN, NPS, INDEX, or custom box-category label.",
             valid_values_text = "NET POSITIVE, MEAN, NPS, INDEX, or custom label"),
