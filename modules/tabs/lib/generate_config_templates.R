    ...
    list(
      ...
      fields = list(
        ...
        list(name = "chart_palette_preset", default = "warm", required = TRUE,
             description = "Colour palette for stacked bar charts. warm = earth tones, cool = blue-anchored, research = purple-green diverging, teal = monochromatic teal gradient, brand = monochromatic gradient from brand_colour.",
             valid_values_text = "warm, cool, research, teal, or brand",
             dropdown = c("warm", "cool", "research", "teal", "brand")),
