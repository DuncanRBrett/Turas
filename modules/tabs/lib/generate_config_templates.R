    ...
    list(
      ...
      fields = list(
        ...
        list(name = "chart_palette_preset", default = "warm", required = TRUE,
             description = "Colour palette for ordinal/scale stacked bar charts. Warm = earth tones, cool = blue-anchored, research = purple-green diverging.",
             valid_values_text = "warm, cool, or research",
             dropdown = c("warm", "cool", "research")),
