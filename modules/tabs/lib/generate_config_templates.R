      ...
      fields = list(
        ...
        list(name = "html_report_v2_microdata", default = "TRUE", required = FALSE,
             description = paste0("Embed the anonymised per-respondent microdata island in the v2 report ",
               ...
               "published aggregates only, and the live features + the Tracking tab switch off for ",
               "that build. FALSE is REQUIRED wherever min_reporting_base is a promise - with the ",
