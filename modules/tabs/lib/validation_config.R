...
# VALIDATION_CONFIG.R
# ==============================================================================
# Crosstab configuration validation functions
...
#
# FUNCTIONS:
# - validate_crosstab_config(): Main validation function
# - check_alpha_config(): Validate alpha configuration
# - check_min_base(): Validate minimum base
