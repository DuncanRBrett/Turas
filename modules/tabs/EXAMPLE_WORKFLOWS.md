...
1. [Workflow 1: Basic Brand Tracking Survey](#workflow-1-basic-brand-tracking-survey)
2. [Workflow 2: Customer Satisfaction with NPS](#workflow-2-customer-satisfaction-with-nps)
3. [Workflow 3: Weighted Survey Analysis](#workflow-3-weighted-survey-analysis)
4. [Workflow 4: Multi-Banner Crosstabulation](#workflow-4-multi-banner-crosstabulation)
5. [Workflow 5: Advanced Filtering and Segmentation](#workflow-5-advanced-filtering-and-segmentation)
6. [Workflow 6: Rating Scale Analysis with Significance](#workflow-6-rating-scale-analysis-with-significance)
7. [Workflow 7: Multi-Mention Question Analysis](#workflow-7-multi-mention-question-analysis)
8. [Workflow 8: Composite Metrics and Custom Scores](#workflow-8-composite-metrics-and-custom-scores)
9. [Workflow 9: Large Dataset Processing](#workflow-9-large-dataset-processing)
10. [Workflow 10: Integration with Turas Parser](#workflow-10-integration-with-turas-parser)
