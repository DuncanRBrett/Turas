...
write_pricing_output <- function(results, plots, validation, config, output_file,
  ...
  # The WTP distribution, competitive-scenario and constrained-optimisation
  # sheets were written here for results the pipeline never produces (the
  # 07/08/09 API tier has no production caller; review M13). Removed rather
