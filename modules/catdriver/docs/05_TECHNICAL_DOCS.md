...
5. **No Silent Degradation:** Uses "refuse rather than guess" philosophy
...
**Validation:**
- Required sheets exist (Settings, Variables)
...
- Apply treatment contrasts (not polynomial)
- Build model formula
...
**Dispatches to:**
- `run_binary_logistic()` - 2 categories
- `run_ordinal_logistic()` - ordered 3+
- `run_multinomial_logistic()` - unordered 3+
...
**Statistical:**
- No weighted ordinal/multinomial (limited)
- No robust standard errors
- No interaction terms
- No multiple imputation

**Technical:**
- Memory-bound for >100K rows
- Multinomial slow with >10 categories
- GUI has no progress bar or cancellation
